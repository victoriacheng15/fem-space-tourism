...
const MainContainer = ({ children, pageType = 'home' }) => {
  const classes = {
    home: 'main-bg bg-home-mobile md:bg-home-tablet bpCustom:bg-home-desktop before:bg-home-mobile md:before:bg-home-table bpCustom:before:bg-home-desktop pb-8 pt-36 text-clrLight-925 before:rotate-180 md:pt-52 bpCustom:pt-96',
  ...
  return <main className={classes[pageType]}>{children}</main>;
};
